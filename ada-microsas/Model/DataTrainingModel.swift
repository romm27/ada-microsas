...
struct DataTrainingModel {
    ...
    static let corridaParada30s = ActivityPhase(name: "Corrida Parada", duration: 30, isRest: false, imageAsset: "BelezinhaAquecimento", spriteKitSceneType: Corrida.self)
    ...
    static let panturrilha30s = ActivityPhase(name: "Panturrilha em Pé", duration: 30, isRest: false, imageAsset: "BelezinhaAquecimento", spriteKitSceneType: Panturrilha.self)
    ...
    static let rest60s = ActivityPhase(name: "Recuperando", duration: 30, isRest: true, imageAsset: "BelezinhaDescanso")
